#!/bin/bash
#SBATCH --job-name=testing_index
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem-per-cpu=4G
#SBATCH --time=24:00:00
#SBATCH --partition=zhanglab.p
#SBATCH --output=/srv/disk00/cheyul1/Venus/logs/22-04-07/testing_index.log
...
out_dir=/srv/disk00/cheyul1/Venus/outputs/22-04-07/testing_index
